    ...
    value: function () {
      function render() {
        ...
        var _props4 = this.props,
            ...
            showDefaultInputIcon = _props4.showDefaultInputIcon;

        var inputIcon = _react2['default'].createElement(_calendar2['default'], null);
        ...
        }, showDefaultInputIcon && _react2['default'].createElement('span', { className: 'DateInput__input-icon' }, inputIcon), _react2['default'].createElement('input', {
